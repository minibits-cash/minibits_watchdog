...
function toMintSnapshot(u: MintReading['units'][number]) {
    return {
        ...
        onchainInflight: u.onchainInflight,
        onchainInflightCount: u.onchainInflightCount,
        onchainInflightStale: u.onchainInflightStale,
        onchainInflightStaleCount: u.onchainInflightStaleCount,
        onchainInflightOldestSec: u.onchainInflightOldestSec,
        onchainQuotes: u.onchainQuotes,
        walletConfirmed: u.walletConfirmed,
        walletTrustedPending: u.walletTrustedPending,
        walletUntrustedPending: u.walletUntrustedPending,
        walletImmature: u.walletImmature,
        walletTrustedSpendable: u.walletTrustedSpendable,
        ...
        depositsDust: u.depositsDust,
        depositsDustCount: u.depositsDustCount,
